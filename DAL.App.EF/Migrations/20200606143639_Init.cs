    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    PolicyName = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyRoomId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResrvationId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomPropertyId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    PropertyRoomsId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Facilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Facilities_PropertyRooms_PropertyRoomsId",
                        column: x => x.PropertyRoomsId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    PropertyRoomsRoomId = table.Column<Guid>(nullable: false),
                    PropertyRoomsId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomPolicies_PropertyRooms_PropertyRoomsId",
                        column: x => x.PropertyRoomsId,
                        principalTable: "PropertyRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    FacilityId = table.Column<Guid>(nullable: false),
                    PropertyRoomsId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomFacilities_PropertyRooms_PropertyRoomsId",
                        column: x => x.PropertyRoomsId,
                        principalTable: "PropertyRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Facilities_PropertyRoomsId",
                table: "Facilities",
                column: "PropertyRoomsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyRooms_PropertyId",
                table: "PropertyRooms",
                column: "PropertyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomFacilities_PropertyRoomsId",
                table: "RoomFacilities",
                column: "PropertyRoomsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomPolicies_PropertyRoomsId",
                table: "RoomPolicies",
                column: "PropertyRoomsId");
