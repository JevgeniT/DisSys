...
namespace DAL.App.EF
{
    public class ReservationRepository : EFBaseRepository<Reservation,AppDbContext>,  IReservationRepository
    {
        ...
        public async Task<IEnumerable<Reservation>> AllAsync(int? userId = null)
        {
            if (userId == null)
            {
        ...
        public async Task<Reservation> FirstOrDefaultAsync(int id, int? userId = null)
        {
        ...
        public async Task<IEnumerable<Reservation>> DTOAllAsync(int? userId = null)
        {
            throw new System.NotImplementedException();
        }
        
        public async Task<Reservation> DTOFirstOrDefaultAsync(int id, int? userId = null)
        {
            throw new System.NotImplementedException();
        }
    }
