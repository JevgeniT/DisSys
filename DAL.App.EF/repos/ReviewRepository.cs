...
{
    public class ReviewRepository : EFBaseRepository<Review,AppDbContext>,  IReviewRepository
    {
        ...
        public async Task<IEnumerable<Review>> AllAsync(int? userId = null)
        {
            if (userId == null)
            {
        ...
        public async Task<Review> FirstOrDefaultAsync(int id, int? userId = null)
        {
        ...
        public async Task<IEnumerable<Review>> DTOAllAsync(int? userId = null)
        {
            throw new System.NotImplementedException();
        }
        
        public async Task<Review> DTOFirstOrDefaultAsync(int id, int? userId = null)
        {
            throw new System.NotImplementedException();
        }
    }
