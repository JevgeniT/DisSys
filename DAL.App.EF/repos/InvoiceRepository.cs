...
namespace DAL.App.EF
{
    public class InvoiceRepository : EFBaseRepository<Invoice,AppDbContext>,  IInvoiceRepository
    {
        ...
        public async Task<IEnumerable<Invoice>> AllAsync(int? userId = null)
        {
            if (userId == null)
            {
        ...
        public async Task<Invoice> FirstOrDefaultAsync(int id, int? userId = null)
        {
        ...
        public async Task<IEnumerable<Invoice>> DTOAllAsync(int? userId = null)
        {
            throw new System.NotImplementedException();
        }
        
        public async Task<Invoice> DTOFirstOrDefaultAsync(int id, int? userId = null)
        {
            throw new System.NotImplementedException();
        }
    }
